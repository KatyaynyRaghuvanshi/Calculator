...
namespace Calculator_Application
{
    ...
    public partial class Calculator : Form
    {
        ...
        private readonly EvaluateExpression Evaluator;
        ...
        public Calculator()
        {
            ...
            ListLabel = new Label();
            Evaluator = new EvaluateExpression();
        ...
        private void InitializeMemoryList()
        {
            ...
            MemoryListView.Font = new Font("Times New Roman", 22F, FontStyle.Regular);
        ...
        private void InitializeDisplay()
        {
            ...
            ExpressionDisplayBox.Font = new Font("Times New Roman", 14F, FontStyle.Regular);
            ...
            ResultDisplayBox.Font = new Font("Times New Roman", 24F, FontStyle.Regular);
            ...
            ApplicationLabel.Font = new Font("Times New Roman", 20F, FontStyle.Regular);
            ApplicationLabel.Name = "ApplicationLabel";
            ApplicationLabel.Text = "Calculator";
            ApplicationLabel.TextAlign = ContentAlignment.TopLeft;
            ...
            ListLabel.Font = new Font("Times New Roman", 14F, FontStyle.Regular);
            ListLabel.Name = "MemoryLabel";
            ListLabel.Text = "Memory";
        ...
        private void InitializeButton()
        {
            ...
            foreach (Button button in buttons)
            {
                ...
                if (buttonInfo[i].Panel == "Memory") memoryKeyPanel.Controls.Add(button, buttonInfo[i].X, buttonInfo[i].Y);
                if (buttonInfo[i].Panel == "Calculator") operatorOperandKeyPanel.Controls.Add(button, buttonInfo[i].X, buttonInfo[i].Y);
        ...
        private void operatorOperandKeyPanel_Paint(object sender, PaintEventArgs e)
        {

        }

        private void displayKeyPanel_Paint(object sender, PaintEventArgs e)
        {
